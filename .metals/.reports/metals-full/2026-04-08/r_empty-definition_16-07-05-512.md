error id: file://<WORKSPACE>/src/test/java/com/authservice/interfaces/rest/AuthControllerIntegrationTest.java:org/springframework/test/web/servlet/result/MockMvcResultMatchers#status().
file://<WORKSPACE>/src/test/java/com/authservice/interfaces/rest/AuthControllerIntegrationTest.java
empty definition using pc, found symbol in pc: org/springframework/test/web/servlet/result/MockMvcResultMatchers#status().
empty definition using semanticdb
empty definition using fallback
non-local guesses:

offset: 1835
uri: file://<WORKSPACE>/src/test/java/com/authservice/interfaces/rest/AuthControllerIntegrationTest.java
text:
```scala
